...
//	 }  		
	...
	$('#villap-text').show()
	$('#villap').css({'backgroundPosition': 'center 90px'}).click(function(){
		$('.tooltip').hide();
		$('#villap-text').show();
		$(this).css({'backgroundPosition': 'center 90px'});
		$('#kingschair, #vodka').css({'backgroundPosition': 'center bottom'});
		$('#pptsalon').css({'backgroundPosition': 'center 120px'});
		//$(this).unbind('mouseout');
		return false;
	});
    
    $('#pptsalon').click(function(){
    	$('.tooltip').hide();
    	$('#pptsalon-text').show();
    	$(this).css({'backgroundPosition': 'center 90px'});
    	$('#villap, #kingschair, #vodka').css({'backgroundPosition': 'center bottom'});
    	return false;
    });	
    
    $('#kingschair').click(function(){
    	$('.tooltip').hide();
    	$('#kingschair-text').show();
    	$(this).css({'backgroundPosition': 'center 90px'});
    	$('#villap, #vodka').css({'backgroundPosition': 'center bottom'});
    	$('#pptsalon').css({'backgroundPosition': 'center 120px'});
    	return false;
    });
    ...
    $('#vodka').click(function(){
    	...
    	$('#vodka-text').show();
    	$(this).css({'backgroundPosition': 'center 90px'});
    	$('#villap, #kingschair').css({'backgroundPosition': 'center bottom'});
    	$('#pptsalon').css({'backgroundPosition': 'center 120px'});
    	return false;
    });	
