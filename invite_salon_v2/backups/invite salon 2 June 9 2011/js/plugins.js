...
/*	$('#intro, #second, #third, #fourth').bind('inview', function (event, visible) {
	...
	function initialPos () {
		...
		$secondBG.css({'backgroundPosition': secondX  +'%' + ' ' + secondY + 'px'});	
	...
	*/
	...
	function position(x, windowWidth, pos, adjuster, inertia){
		...
		//return  (-((windowWidth + pos) - adjuster) * inertia)  + "px" + x + "% ";
		newPosition = newPosition + 121.76; //will intially output 50%;
	...
	/*	if($firstBG.hasClass("inview")){
		...
		//if($secondBG.hasClass("inview")){
			//call the newPos function and change the background position
			$secondBG.css({'backgroundPosition': newPos(secondY, windowWidth, pos, 2420, 0.02)});
			$thirdBG.css({'backgroundPosition': newPos(thirdY, windowWidth, pos, 5275, 0.02)});
			$fourthBG.css({'backgroundPosition': newPos(fourthY, windowWidth, pos, 3600, 0.017)});
			$fiveBG.css({'backgroundPosition': newPos(45, windowWidth, pos, 3000, 0.058)});
	...
	//		trainers.css({'backgroundPosition': newPos(50, windowWidth, pos, 1900, 0.6)});
			$sea.css({'backgroundPosition': position(seaY, windowWidth, pos, seaAdjuster, 0.040)});
	//	}
