...
/*	$('#intro, #second, #third, #fourth').bind('inview', function (event, visible) {
	...
	*/
	...
	function position(x, windowWidth, pos, adjuster, inertia){
		...
		//return  (-((windowWidth + pos) - adjuster) * inertia)  + "px" + x + "% ";
		newPosition = newPosition + 64; //will intially output 0%;
	...
	/*	if($firstBG.hasClass("inview")){
		...
		//if($secondBG.hasClass("inview")){
			//call the newPos function and change the background position
			$secondBG.css({'backgroundPosition': newPos(160, windowWidth, pos, 1830, 0.04)});
			$thirdBG.css({'backgroundPosition': newPos(170, windowWidth, pos, 2975, 0.05)});
			$fourthBG.css({'backgroundPosition': newPos(0, windowWidth, pos, 1800, 0.09)});
			...
			$seven.css({'backgroundPosition': newPos(0, windowWidth, pos, 6980, 0.05)});
	...
	//		trainers.css({'backgroundPosition': newPos(50, windowWidth, pos, 1900, 0.6)});
			$sea.css({'backgroundPosition': position(0, windowWidth, pos, 0, 0.063)});
	//	}
