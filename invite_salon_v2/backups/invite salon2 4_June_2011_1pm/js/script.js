...
//inview
    $(window).bind("scroll", function(event) {
		...
		//$('nav.menu a').addClass($activeClass);
...
//        $(".quote :in-viewport").each(function() {
        	//$("body").append("<p>working</p>");
//        });
        
//        $("#quote1 :right-of-screen").each(function() {
//          $('#aboutus-href').addClass($activeClass);
//        });
//        $("#quote1 :left-of-screen").each(function() {
//          $('#aboutus-href').removeClass($activeClass);
//        });
...
//        $("#quote3 :in-viewport").each(function() {
//          $('#portfolio-href').removeClass($activeClass);
//        });
		...
		$("#faq :in-viewport").each(function() {
		  ...
		  //$('nav.menu li a :not(#contactus-href)').removeClass($activeClass);
		  //$('#team-href').removeClass($activeClass);
        });
...
//        });
//        
//        $("#quote3  :out-viewport").each(function() {
//          $('nav.menu a').removeClass($activeClass);
//        });       
    });
