...
//          var height = image.height();
          ...
          var sub_caption = image.attr('alt');
          ...
          image
           ...
           .parent()
            ...
            .prepend('<h3>'+ caption +'</h3><p>'+ sub_caption +'</p><span class="eye"></span>')
            .find('h3')
            ...
            var h3 = image.parent().find('h3');
            //20px additional adjustment.
            image.parent().find('p').css({
            	'position': 'absolute',
            	'top': eleHeight(h3, 24) + 18 +'px'
            }).hide();
            ...
            image.parent().hover(function() {
              $(this).addClass('hover_caption').find('h3, p').show();
            }, function() {
              $(this).removeClass('hover_caption').find('h3, p').hide();
            });
